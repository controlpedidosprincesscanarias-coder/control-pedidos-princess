...
_(La última — el bloqueo de ENVIADO AL PROVEEDOR con "sin correo" justo
tras subir el PDF del pedido oficial — se cerró el 9 de septiembre, ver
`CHANGELOG.md` v12.32.47. Antes de esa, Reply-To del envío manual de
reclamación desde el panel (`meaEnviarEmail`), cerrada el mismo día en
v12.32.45.)_
