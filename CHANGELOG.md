...
**Revisión de otros documentos (norma 5)**: `README.md` sí (versión actual). `PENDIENTES.md` — no aplica, este trabajo no estaba registrado ahí. `GUIA_DESPLIEGUE.md`, `INSTRUCCIONES_RESTAURACION.md` — no aplica. `docs/hallazgo-seguridad-princess.md` — no existe en este repo (ver nota de norma 5 en `docs/HISTORIAL_CAMBIOS.md`).
